...
@section('page_title', __('New Page'))
            ...
            <div class="col">
                <div id="post-type" class="card h-auto mb-3">
                    <div class="card-header">
                        <h1 class="card-title">{{ __('New Page') }}</h1>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-body text-dark">/</span>
                        ...
                        <div class="mb-3 @error('summary')  is-invalid @enderror">
                            ...
                            <textarea name="summary" class="form-control  @error('title')  is-invalid @enderror">{{ old('summary') }}</textarea>
                            @error('summary')
                                <small class="invalid-feedback">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <select class="w-100 form-control mr-sm-2" name="layout">
                            @foreach ($layouts as $lk => $lv)
                                <option value="{{ str_replace('theme::layouts.', '', $lk) }}">{{ $lv }}</option>
                            @endforeach
                        </select>
                        @error('layout')
                            <small class="invalid-feedback">{{ $message }}</small>
