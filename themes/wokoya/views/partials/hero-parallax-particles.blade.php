<!-- Start Hero -->
<div id="home" class="hero-section hero-section-bg jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('{{__o('hero_image')}}')">
    ...
    <div class="hero-single sidebar-hero-bg">
        <div class="container">
            ...
            <div class="row">
                <!-- start row -->
                <div class="col-md-6 offset-md-1 col-sm-12 pl-20">
                    <!-- hero text left -->
                    <div class="hero-content wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".6s">
                        ...
                        {{__('theme::hero.first_name') }} <span class="colored">{{__('theme::hero.last_name' )}}.</span>
                        </h2>
                        <div class="typed-strings">
                        {!! __('theme::hero.description') !!}
                        </div>
...
@push('scripts')
<script src="{{ asset('themes/wokoya/assets/js/jquery.particles.min.js') }}"></script>
@endpush
