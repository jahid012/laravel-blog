            ...
            <div class="row">	<!-- start row -->
                <div class="col-md-6 offset-md-1 col-sm-12 pl-20">	<!-- hero text left -->
                    <div class="hero-content wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".6s">
                        <h2 data-splitting class="top-title pt-30 wow fadeInUp" data-wow-duration=".001s" data-wow-delay=".001s">{{__('theme::hero.first_name') }} <span class="colored">{{__('theme::hero.last_name' )}}.</span></h2>
