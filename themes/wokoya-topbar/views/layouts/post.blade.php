                    ...
                    <div class="col">
                        ...
                        <div class="mt-40 wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".6s">
                            ...
                            <div class="d-flex flex-row mb-3">
                                <div class="p-1"><i class="icofont-ui-user"></i> {{ $page->auth->getFullName() }}</div>
                                <div class="p-1"><i class="icofont-calendar"></i> {{ $page->created_at->format('d M, y ') }}</div>
                                <div class="p-1"><i class="icofont-location-arrow"></i> {{ $page->category->name }}</div>
                                <div class="p-1">
                                @if ($page->tags)
                                    <span>
