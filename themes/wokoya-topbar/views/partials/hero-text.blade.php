<!-- Start Hero
============================================= -->
<div id="home" class="hero-section hero-section-bg hero-content hero-3">
    ...
    <div class="hero-single">
        <div class="container">	<!-- start container -->
            <div class="row">	<!-- start row -->
                <div class="col-md-12">	<!-- hero text left -->
                    <div class="hero-content text-center mt-40 wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".6s">
                        <span class="top-title wow fadeInUp" data-wow-duration=".6s" data-wow-delay=".7s">
                        {{__('theme::hero.first_name') }} {{__('theme::hero.last_name') }}
                        </span>
                        <div class="typed-strings">{!! __('theme::hero.description') !!}</div>
                        <h2 class="text-16 text-center header_type_text text-white mb-2 mb-md-3">
                        ...
                        <div class="hro-btn header-btn wow fadeInUp" data-wow-duration=".6s" data-wow-delay=".9s">
                            <a href="{{ __o('download_cv_link') }}" class="theme-btn text-center">
